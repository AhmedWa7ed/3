...
<div className='row'>
<div className='col-lg-6 col-sm-12 d-flex justify-content-between mt-2' style={{width: "300px", marginRight: "130px" }}>
<div className='d-flex'>{/* text-img */}
<div>
<div className='cont '>
<span className=''>213+</span>
...
<div className='col-lg-6 col-sm-12 d-flex justify-content-between mt-2 ' style={{width: "20px"}}>
            
                   {/* box 4  */}
                   <div >
                   <div className='cont ' style={{marginLeft: "-40px"}}>
                   <span className='' >3,24</span>
                   </div>
                   </div>
                      {/* Arsenal 4  */}
                   ...
                   <div className='d-flex justify-content-between' style={{width: "150px" , marginLeft:"-150px"}}>
